  ...
  <section id="main" className="wrapper">
    <div className="container">
      ...
      <p>
        ...
        boundary aganst a color satellite image as background at top, and a Data
      ...
      <p>
        ...
        <br />
        <b>Step 2-</b>Enter the <b>First name</b> in it's column.
        <br />
      ...
      <p>
        ...
        <br />
        <b>Contains</b> is the default, however, when enteing the last name,{" "}
        <b>Equals</b> may be a preferred choice.
        <br />
        Statistics appear at the bottom right of the input screen. Tapping
        directional carrots illustrated below ( <b>&lt; &gt;</b> ) allows
      ...
      <h5>Usage Notes:</h5>The burials database contains 100,000 records,
      including recent burials up to May 2021. It is acknowledged that not all
      ARC burials are included in this database. Many older burials and burial
      places require further investigation. Work is continuing to improve these
      data.
      <br />A high percentage of records contain a Death date which can assist
      in record selection, as can the Birth date if this value has been
      recorded. Both fields can be filtered using the same process employed with
      the name fields.
      <br />
      ...
      <br /> The table of contents has been expanded to include 2 different
      image backgrounds. The source titled “Image Clarity” has higher resolution
      at maximum zoom scale.
      <br />
